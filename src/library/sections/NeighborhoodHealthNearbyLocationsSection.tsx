...
type NeighborhoodHealthNearbyLocationsSectionProps = {
  cardStyles: {
...
const neighborhoodHealthNearbyLocationsFields: YextFields<NeighborhoodHealthNearbyLocationsSectionProps> =
  {
    section: {
      label: "Section",
      type: "object",
 ...
 */
const NeighborhoodHealthNearbyLocationsSectionComponent: PuckComponent<
  NeighborhoodHealthNearbyLocationsSectionProps
> = ({ cardStyles, heading, id, limit, map, puck, radius, section }) => {
  ...
  const scopeName = `YextNeighborhoodHealthNearbyLocationsSection${getAnalyticsScopeHash(
    id,
  )}`;
...
h6, h6[class] { font-family: var(--fontFamily-h6-fontFamily); font-size: var(--fontSize-h6-fontSize); line-height: 1.2; font-weight: var(--fontWeight-h6-fontWeight); font-style: var(--fontStyle-h6-fontStyle); text-transform: var(--textTransform-h6-textTransform); }
      ...
      <AnalyticsScopeProvider name={scopeName}>
        ...
        >
          <style>{`
            .yext-neighborhood-health-nearby-map .mapbox-static-map-shell,
            .yext-neighborhood-health-nearby-map .mapbox-static-map-picture,
            .yext-neighborhood-health-nearby-map .mapbox-static-map-image {
              height: 100%;
              width: 100%;
            }
...
export const NeighborhoodHealthNearbyLocationsSection: YextComponentConfig<NeighborhoodHealthNearbyLocationsSectionProps> =
  {
    ...
    fields: toPuckFields(neighborhoodHealthNearbyLocationsFields),
    defaultProps: {
      map: {
        zoom: 10,
        height: "100%",
      ...
      heading: {
        text: {
          ...
          constantValue: {
            ...
            defaultValue: "Nearby [[name]] Facilities",
          },
    ...
    render: (props) => (
      <NeighborhoodHealthNearbyLocationsSectionComponent {...props} />
    ),
  };
