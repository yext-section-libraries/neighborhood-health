...
type NeighborhoodHealthHeaderProps = {
...
const NeighborhoodHealthHeaderComponent: PuckComponent<
...
export const NeighborhoodHealthHeader: YextComponentConfig<NeighborhoodHealthHeaderProps> =
  {
    ...
    render: (props) => (
      <AnalyticsScopeProvider
        name={`NeighborhoodHealthHeader${getAnalyticsScopeHash(props.id)}`}
      >
        <NeighborhoodHealthHeaderComponent {...props} />
      </AnalyticsScopeProvider>
    ),
  };

export const config: SectionConfig = {
  id: "NeighborhoodHealthHeader",
  displayName: "Header",
  description: "Header",
