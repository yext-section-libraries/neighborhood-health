...
type NeighborhoodHealthLocationDetailsSectionProps = {
  section: {
...
const neighborhoodHealthLocationDetailsFields: YextFields<NeighborhoodHealthLocationDetailsSectionProps> =
  {
    section: {
    ...
    servicesCard: {
      ...
      objectFields: {
        ...
        accessibilitySubheading: {
          type: "entityField",
          label: msg("fields.accessibilitySubheading", "Accessibility Subheading"),
          filter: {
            types: ["type.string"],
          },
        },
 ...
 */
const NeighborhoodHealthLocationDetailsSectionComponent: PuckComponent<
  NeighborhoodHealthLocationDetailsSectionProps
> = ({
  cards,
  hoursCard,
  id,
  ...
  const scopeName = `YextNeighborhoodHealthLocationDetailsSection${getAnalyticsScopeHash(
    id,
  )}`;
...
.yext-neighborhood-health-hours .HoursTable-day, .yext-neighborhood-health-hours .HoursTable-intervals, .yext-neighborhood-health-hours .HoursTable-interval { min-width: 0; }
.yext-neighborhood-health-hours .HoursTable-intervals { text-align: right; }
.yext-neighborhood-health-hours .HoursTable-interval { white-space: normal; overflow-wrap: anywhere; }
.yext-neighborhood-health-hours .is-today .HoursTable-day, .yext-neighborhood-health-hours .is-today .HoursTable-interval { font-weight: bolder; }
      `}</style>
              ...
              <BackgroundProvider value={cardBackgroundContext}>
                ...
                >
                  ...
                  {resolvedHours ? (
                    ...
                    >
                      <div
                        className="yext-neighborhood-health-hours mt-5 flex min-w-0 flex-col items-start"
...
export const NeighborhoodHealthLocationDetailsSection: YextComponentConfig<NeighborhoodHealthLocationDetailsSectionProps> =
  {
    ...
    render: (props) => (
      <NeighborhoodHealthLocationDetailsSectionComponent {...props} />
    ),
  };
